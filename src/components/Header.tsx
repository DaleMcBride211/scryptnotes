            ...
            <div className="flex items-center gap-4"> {/* Grouped Sheet trigger and DarkModeToggle */}
                <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                    ...
                    <SheetContent className="sm:max-w-lg w-full flex flex-col"> {/* Added flex flex-col for layout */}
                        ...
                        <div className="py-4 flex-grow flex flex-col gap-4"> {/* Added flex-grow */}
                            <Textarea
                            ...
                            {aiResponse && !error && (
                                <div className="mt-4 p-3 border rounded-md bg-muted flex-grow min-h-[100px]"> {/* Added flex-grow and min-h */}
                                    <h3 className="font-semibold mb-2">Gemini's Response:</h3>
                                    <ScrollArea className="h-[300px] whitespace-pre-wrap"> {/* Or adjust height as needed */}
                                        {aiResponse}
                                    </ScrollArea>
                                </div>
                            )}
